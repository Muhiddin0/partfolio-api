...
class IncrementProjectViewCountView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        viewer, created = models.Viewer.objects.get_or_create(ip=ip_address, project=project)
        ...
        return Response({"message": message, "views": models.Viewer.objects.filter(project=project).count()}, status=status.HTTP_200_OK)
